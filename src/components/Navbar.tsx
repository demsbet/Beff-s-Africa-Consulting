  ...
  return (
    <nav
      className={cn(
        ...
        (scrolled || location.pathname === '/admin') ? "bg-white shadow-md py-2" : "bg-transparent py-4"
      )}
    >
        ...
        <div className="flex justify-between items-center">
          <Link to="/" className="flex items-center space-x-2">
            ...
            <span className={cn(
              ...
              (scrolled || location.pathname === '/admin') ? "text-gray-900" : "text-white"
            )}>
              ...
              <Link
                ...
                className={cn(
                  ...
                  location.pathname === link.path
                    ? "text-secondary"
                    : (scrolled || location.pathname === '/admin') ? "text-gray-700" : "text-white"
                )}
              >
                {link.name}
              </Link>
